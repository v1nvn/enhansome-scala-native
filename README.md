...
* [Giter8 template for a minimal Scala Native project](https://github.com/scala-native/scala-native.g8) ⭐ 79 | 🐛 1 | 🌐 Scala | 📅 2026-02-13 - Official [Giter8](http://www.foundweekends.org/giter8/) template for a minimal Scala Native project.
...
* [Building C code using sbt-jni](https://github.com/nadavwr/scala-native-sbt-jni-example) ⭐ 6 | 🐛 0 | 🌐 CMake | 📅 2017-05-19 - Example for compiling C code in a Scala Native project using [sbt-jni](https://github.com/jodersky/sbt-jni) ⭐ 133 | 🐛 8 | 🌐 Scala | 📅 2026-02-09.
...
* [Mill](https://github.com/com-lihaoyi/mill) ⭐ 2,689 | 🐛 156 | 🌐 Scala | 📅 2026-02-13 - Build tool striving for simplicity, inspired by [Bazel](https://www.bazel.build/).
* [Bloop](https://github.com/scalacenter/bloop) ⭐ 938 | 🐛 87 | 🌐 Scala | 📅 2026-02-11 - Scala build server and command-line tool for fast developer workflows.
* [Seed](https://github.com/tindzk/seed) ⭐ 238 | 🐛 24 | 🌐 Scala | 📅 2020-12-11 - Build tool based on Bloop. Focuses on user experience and cross-platform builds, inspired by [Cargo](https://github.com/rust-lang/cargo) ⭐ 14,587 | 🐛 1,572 | 🌐 Rust | 📅 2026-02-13.
* [sbt](https://www.scala-sbt.org/) - Scala's standard build tool.

## Functional Programming

* [Cats](https://github.com/typelevel/cats) ⭐ 5,412 | 🐛 261 | 🌐 Scala | 📅 2026-02-11 - Abstractions for functional programming in Scala.
* [scalaz](https://github.com/scalaz/scalaz) ⭐ 4,677 | 🐛 155 | 🌐 Scala | 📅 2026-02-09 - Type classes and instances for data structures.
* [Shapeless](https://github.com/milessabin/shapeless) ⭐ 3,410 | 🐛 28 | 🌐 Scala | 📅 2026-02-05 - Library for generic programming.
* [chimney](https://github.com/scalalandio/chimney) ⭐ 1,240 | 🐛 23 | 🌐 Scala | 📅 2026-02-12 - Boilerplate-free data transformations.
...
* [reactify](https://github.com/outr/reactify) ⭐ 90 | 🐛 1 | 🌐 Scala | 📅 2026-02-09 - Functional Reactive Programming framework for Scala.
* [nobox](https://github.com/xuwei-k/nobox) ⭐ 33 | 🐛 0 | 🌐 Scala | 📅 2026-02-11 - Immutable primitive array wrapper without boxing.

## Unit Tests

* [ScalaCheck](https://github.com/typelevel/scalacheck) ⭐ 1,962 | 🐛 63 | 🌐 Scala | 📅 2026-02-11 - Property-based testing for Scala.
* [ScalaTest](https://github.com/scalatest/scalatest) ⭐ 1,167 | 🐛 543 | 🌐 Scala | 📅 2025-11-14 - Testing library.
* [specs2](https://github.com/etorreborre/specs2) ⭐ 737 | 🐛 9 | 🌐 Scala | 📅 2026-02-12 - Software Specifications for Scala.
* [µTest](https://github.com/lihaoyi/utest) ⭐ 509 | 🐛 17 | 🌐 Scala | 📅 2026-01-22 - Library for unit tests.
* [MUnit](https://github.com/scalameta/munit) ⭐ 464 | 🐛 40 | 🌐 Scala | 📅 2026-02-13 - Scala testing library with actionable errors and extensible APIs.
* [scalaprops](https://github.com/scalaprops/scalaprops) ⭐ 279 | 🐛 10 | 🌐 Scala | 📅 2026-02-11 - Library for property-based testing.
  * [scalaprops-shapeless](https://github.com/scalaprops/scalaprops-shapeless) ⭐ 10 | 🐛 2 | 🌐 Scala | 📅 2026-02-11 - Generation of arbitrary ADT instances.
  * [scalaprops-cross-example](https://github.com/scalaprops/scalaprops-cross-example) ⭐ 4 | 🐛 0 | 🌐 Scala | 📅 2026-02-09 - Cross-platform example.
...
* [libui](https://github.com/lolgab/scalaui) ⭐ 73 | 🐛 0 | 🌐 Scala | 📅 2024-07-18 - GUI framework based on [libui](https://github.com/andlabs/libui) ⭐ 10,859 | 🐛 249 | 🌐 C | 📅 2024-05-29.
...
* [BLAS](https://github.com/ekrich/sblas) ⭐ 35 | 🐛 1 | 🌐 Scala | 📅 2026-02-09 - Bindings for [BLAS](http://www.netlib.org/blas/), a library for Linear Algebra.
...
* [cmark](https://github.com/sparsetech/cmark-scala) ⭐ 16 | 🐛 0 | 🌐 Scala | 📅 2021-09-14 - Bindings for the [cmark](https://github.com/commonmark/cmark) ⭐ 1,919 | 🐛 70 | 🌐 C | 📅 2025-12-21 CommonMark parser library.
* [libuv](https://github.com/TimothyKlim/scala-native-libuv) ⭐ 10 | 🐛 0 | 🌐 Scala | 📅 2017-04-29 - Bindings for [libuv](https://github.com/libuv/libuv) ⭐ 26,571 | 🐛 209 | 🌐 C | 📅 2026-02-14, a library for asynchronous I/O.
...
* [ScalaPB](https://github.com/scalapb/ScalaPB) ⭐ 1,333 | 🐛 59 | 🌐 Scala | 📅 2026-02-05 - [Protocol Buffer](https://developers.google.com/protocol-buffers/) compiler for Scala.
  * [scalapb-argonaut](https://github.com/scalapb-json/scalapb-argonaut) ⭐ 2 | 🐛 0 | 🌐 Scala | 📅 2026-02-11 - JSON and Protocol Buffer converters for ScalaPB based on [Argonaut](http://argonaut.io).
* [FastParse](https://github.com/com-lihaoyi/fastparse) ⭐ 1,129 | 🐛 23 | 🌐 Scala | 📅 2026-01-14 - Library for defining and running parsers.
* [scalatags](https://github.com/com-lihaoyi/scalatags) ⭐ 773 | 🐛 40 | 🌐 Scala | 📅 2025-07-11 - HTML/XML construction and rendering.
* [uPickle](https://github.com/com-lihaoyi/upickle) ⭐ 764 | 🐛 28 | 🌐 Scala | 📅 2026-02-14 - uPickle: a simple, fast, dependency-free JSON & Binary (MessagePack) serialization library for Scala
* [argonaut](https://github.com/argonaut-io/argonaut) ⭐ 546 | 🐛 28 | 🌐 Scala | 📅 2026-02-11 - Purely functional JSON parser and library.
* [sconfig](https://github.com/ekrich/sconfig) ⭐ 132 | 🐛 12 | 🌐 Scala | 📅 2026-02-08 - [HOCON](https://github.com/ekrich/sconfig/blob/master/docs/original/HOCON.md) ⭐ 132 | 🐛 12 | 🌐 Scala | 📅 2026-02-08 parser.
...
* [toml-scala](https://github.com/sparsetech/toml-scala) ⚠️ Archived - [TOML](https://github.com/toml-lang/toml) ⭐ 20,353 | 🐛 14 | 📅 2025-12-24 parser with codec derivation.
* [msgpack4z](https://github.com/msgpack4z/msgpack4z-native) ⭐ 5 | 🐛 1 | 🌐 Scala | 📅 2026-02-11 - Implementation of [MessagePack](https://msgpack.org/), a binary serialisation format.
...
* [skunk](https://github.com/typelevel/skunk) ⭐ 1,640 | 🐛 88 | 🌐 Scala | 📅 2026-02-11 -  A data access library for Scala + Postgres.
...
* [scala-native-jdbc](https://github.com/lolgab/scala-native-jdbc) ⭐ 12 | 🐛 1 | 🌐 Scala | 📅 2026-02-13 - Port of the database access layer [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) to Scala Native.
...
* [sttp](https://github.com/softwaremill/sttp) ⭐ 1,495 | 🐛 30 | 🌐 Scala | 📅 2026-02-14 - HTTP Client library.
* [snunit](https://github.com/lolgab/snunit) ⭐ 147 | 🐛 8 | 🌐 Scala | 📅 2026-02-13 - Scala Native HTTP server based on NGINX Unit.
...
* [scribe](https://github.com/outr/scribe) ⭐ 543 | 🐛 24 | 🌐 Scala | 📅 2026-02-05 - Fast and simple logging library.
* [slogging](https://github.com/jokade/slogging) ⭐ 51 | 🐛 13 | 🌐 Scala | 📅 2020-09-17 - [Typesafe-logging](https://github.com/lightbend/scala-logging) ⭐ 924 | 🐛 29 | 🌐 Scala | 📅 2026-01-30 and [SLF4J](https://www.slf4j.org/)-compatible logging library based on macros.
...
* [decline](https://github.com/bkirwi/decline) ⭐ 669 | 🐛 25 | 🌐 Scala | 📅 2026-02-07 - A composable command-line parser for Scala.
* [fansi](https://github.com/com-lihaoyi/fansi) ⭐ 233 | 🐛 21 | 🌐 Scala | 📅 2025-10-15 - Library for creating [ANSI-coloured strings](https://en.wikipedia.org/wiki/ANSI_escape_code).
...
* [scala-optparse-applicative](https://github.com/xuwei-k/optparse-applicative) ⭐ 16 | 🐛 1 | 🌐 Scala | 📅 2026-02-11 - Port of Haskell's CLI argument parsing library [optparse-applicative](https://hackage.haskell.org/package/optparse-applicative).
...
* [Coursier](https://github.com/coursier/coursier) ⭐ 2,110 | 🐛 462 | 🌐 Scala | 📅 2026-02-11 - Coursier's [`bootstrap` command](https://get-coursier.io/docs/cli-native-bootstrap) generates native launchers.
