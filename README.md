...
* [Mill](https://github.com/com-lihaoyi/mill) ⭐ 2,692 | 🐛 157 | 🌐 Scala | 📅 2026-02-16 - Build tool striving for simplicity, inspired by [Bazel](https://www.bazel.build/).
...
* [Seed](https://github.com/tindzk/seed) ⭐ 238 | 🐛 24 | 🌐 Scala | 📅 2020-12-11 - Build tool based on Bloop. Focuses on user experience and cross-platform builds, inspired by [Cargo](https://github.com/rust-lang/cargo) ⭐ 14,601 | 🐛 1,572 | 🌐 Rust | 📅 2026-02-15.
* [sbt](https://www.scala-sbt.org/) - Scala's standard build tool.

## Functional Programming

* [Cats](https://github.com/typelevel/cats) ⭐ 5,412 | 🐛 262 | 🌐 Scala | 📅 2026-02-15 - Abstractions for functional programming in Scala.
...
* [specs2](https://github.com/etorreborre/specs2) ⭐ 736 | 🐛 9 | 🌐 Scala | 📅 2026-02-12 - Software Specifications for Scala.
* [µTest](https://github.com/lihaoyi/utest) ⭐ 509 | 🐛 17 | 🌐 Scala | 📅 2026-01-22 - Library for unit tests.
* [MUnit](https://github.com/scalameta/munit) ⭐ 464 | 🐛 42 | 🌐 Scala | 📅 2026-02-16 - Scala testing library with actionable errors and extensible APIs.
...
* [libuv](https://github.com/TimothyKlim/scala-native-libuv) ⭐ 10 | 🐛 0 | 🌐 Scala | 📅 2017-04-29 - Bindings for [libuv](https://github.com/libuv/libuv) ⭐ 26,579 | 🐛 209 | 🌐 C | 📅 2026-02-14, a library for asynchronous I/O.
...
* [msgpack4z](https://github.com/msgpack4z/msgpack4z-native) ⭐ 5 | 🐛 1 | 🌐 Scala | 📅 2026-02-15 - Implementation of [MessagePack](https://msgpack.org/), a binary serialisation format.
...
* [sttp](https://github.com/softwaremill/sttp) ⭐ 1,496 | 🐛 31 | 🌐 Scala | 📅 2026-02-15 - HTTP Client library.
